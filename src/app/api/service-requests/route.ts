...
export async function POST(request: Request) {
  ...
  const data = portalStore.createServiceRequest({ customerName: body.customerName, mobile: body.mobile, serviceType: body.serviceType, city: body.city, address: body.address, staffRequired: body.staffRequired });
