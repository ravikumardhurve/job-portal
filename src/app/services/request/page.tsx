...
export default async function ServiceRequestPage({ searchParams }: { searchParams: Promise<{ service?: string | string[]; city?: string | string[] }> }) {
  ...
  const city = requestedCity?.trim().slice(0, 80) || "";
